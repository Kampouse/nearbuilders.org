...
export function initialFormLinks(links?: Record<string, string> | null): Record<string, string> {
  return Object.fromEntries(SOCIAL_LINKS.map(({ key }) => [key, links?.[key] ?? ""]));
}
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <div>
          ...
          <HelperText>
            Full URLs. These show on your profile and override your NEAR Social links.
          </HelperText>
        </div>
